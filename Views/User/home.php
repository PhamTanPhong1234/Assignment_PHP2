...
<head>
    ...
    <style>
        * {
        ...
        #slider {
            ...
            width: 100%;
            height: 80vh;
            background: url('../../../Img/20191127190639-shutterstock-431848417-crop.jpeg') top center no-repeat;
            background-size: 100%;
        }
    ...
    background-color: red;
        ...
        .flex-box-review .review .img2 {
            width: 100%;
            height: 250px;
            background: url('https://hnp.vn/wp-content/uploads/2020/05/tai-nghe-redmi-airdots-h7-1.jpg') right center no-repeat;
            background-size: 110%;
            transition: 0.3s;
        }
                    ...
                    <div class="grid-container">
                        <div class="grid-item item1">
                            <div class="card" style="width: 100%;height: 80%;">
                                <img src="../../../Img/mx-keys-mini-combo-business-gallery-us-graphite-1.png " alt="">
                            </div>
                        ...
                        <div class="grid-item item2">
                            <div class="card" style="width: 100%;height: 80%;">
                                <img src="../../Img/folio-touch-air-gallery-1.png" alt="" style="width: 350px;">
                        ...
                        <div class="grid-item item3">
                            ...
                            <div class="card" style="width: 100%;height: 80%;">
                                <img src="../../Img/4k-pro-gallery-1.png" alt="" style="width: 300px;">
                            </div>
                        ...
                        <div class="grid-item item4">
                            <div class="card" style="width: 100%;height: 80%;">
                                <img src="../../Img/zone-vibe-100-gallery-white-1.png" alt="" style="width: 350px;">
                            </div>
                        ...
                        <div class="grid-item item5">
                            <div class="card" style="width: 100%;height: 80%;">
                                <img src="../../Img/ggt-1.png" alt="" style="width: 300px;">
                            </div>
