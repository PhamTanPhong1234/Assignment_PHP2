...
<body>
    <div id="sitebar">
        ...
        <div class="list">
            <ul>
                <li style="background-color: #FFD33A;"><a style="color: #000;" href="./index.php"><i class="fa-solid fa-list"></i>Danh Sách Sản Phẩm</a></li>
                <li><a href="./addProduct.php"><i class="fa-solid fa-square-plus"></i>Thêm Sản Phẩm</a></li>
                <li><a href="./order.php"><i class="fa-solid fa-list"></i></i>Danh Sách Đơn Hàng</a></li>
                <li><a href=""><i class="fa-solid fa-list"></i></i>Danh Sách Banner</a></li>
    ...
    <div class="logout">
        <a href="../User/index.php"> <i class="fa-solid fa-right-from-bracket"></i></a>
    </div>
</body>
